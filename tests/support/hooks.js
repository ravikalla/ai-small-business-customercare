...
function setupTestRoutes() {
  ...
  this.app.get('/api/knowledge/list', (req, res) => {
    ...
    const entries = Array.from(self.testData.knowledgeEntries.values()).filter(
...
function setupDefaultMocks() {
      ...
      choices: [
        {
          message: {
            content:
              'This is a mock AI response that would answer the customer query based on the business knowledge base.',
          },
        },
      ],
  ...
  twilioMock.post('/2010-04-01/Accounts/test-twilio-sid/Messages.json').reply(200, {
